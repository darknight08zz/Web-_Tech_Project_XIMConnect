...
$events = loadEvents('upcoming');

// Populate upcoming events grid
$upcomingEventsGrid = populateAllUpcomingEvents($events);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Upcoming Events - XIMConnect</title>
    <!-- Add Google Fonts -->
...
<body>
    ...
    <main>
        ...
        <section class="events-section">
            <div class="events-grid" id="all-upcoming-events-grid">
                <?php echo $upcomingEventsGrid; ?>
            </div>
        </section>
    </main>
